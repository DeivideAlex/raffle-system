                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {p.status === 'paid' ? (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button variant="outline" size="sm" className="h-6 px-2 text-[10px] font-bold border-blue-200 text-blue-600 hover:bg-blue-50" onClick={() => handlePay(p)} disabled={loadingPayment}>
                          PAGAR AGORA
                        </Button>
                      </div>
                    )}
